<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="IncomePayrollMaster.aspx.cs" Inherits="Import_PayrollMaster" %>
            ...
            <ContentTemplate>
             ...
             <uc4:StyleContentStart ID="StyleContentStart1" runat="server" />
               ...
               <table id="table1" cellspacing="0" cellpadding="0" width="100%">
                    <tr class="QueryStyle">
                        <td align="left" colspan="2" rowspan="2"><span class="ItemFontStyle"></span>&nbsp;</td>
                    </tr>               
                    <tr class="QueryStyle">
                    </tr>
                    <tr class="QueryStyle">
