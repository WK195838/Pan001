<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="ImportLeaveTrx.aspx.cs" Inherits="Basic_ImportLeaveTrx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
     ...
     <uc2:StyleTitle ID="StyleTitle1" runat="server" Title="請假資料上傳" />
    ...
    <li>
    <asp:Label ID="Label2" runat="server" Text="請假資料：" Width="65px"></asp:Label>
    ...
    請假資料範本(<asp:HyperLink ID="HyperLink2" runat="server" SkinID="TemplateExcel" NavigateUrl="Template/LeaveTrx.xls" Target="_blank" />)
    <br />
</asp:Content>
