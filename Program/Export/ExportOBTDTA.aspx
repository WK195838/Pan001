<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="ExportOBTDTA.aspx.cs" Inherits="ExportOBTDTA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    <uc2:StyleTitle ID="StyleTitle1" runat="server" Title="匯出公司薪轉資料-世華格式" />
        <%--用於執行等畫面(Begin) --%>
    ...
    <li>
    期　　別：<uc6:PeriodList id="PeriodList1" runat="server" />
    </li>
