<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="PYR016.aspx.cs" Inherits="RDLCPYR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <ContentTemplate>
        ...
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="加班資料明細表" />
        ...
        <tr><td colspan="2">
            ...
            <LocalReport ReportPath="RDLC\PYR016.rdlc">
            </LocalReport>
            </rsweb:reportviewer>
        </td></tr>
        <tr><td colspan="2">
        <asp:GridView id="GridView1" runat="server" Width="100%" AllowSorting="True" AllowPaging="True"
         ...
         <Columns>             
             ...
             <asp:BoundField DataField="OverTime_Date" HeaderText="加班日期" />
             <asp:BoundField DataField="Payroll_ProcessingMonth" HeaderText="計薪年月" />
             <asp:BoundField DataField="OverTime1" HeaderText="平日" />
