<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="PYR014.aspx.cs" Inherits="RDLCPYR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <ContentTemplate>
        ...
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="人事基本資料明細表－依部門別" />
        ...
        員工編號：<asp:TextBox ID="txtEmployeeIdS" runat="server" Width="100px"></asp:TextBox>
        ～<asp:TextBox ID="txtEmployeeIdE" runat="server" Width="100px"></asp:TextBox>       
        </td></tr>
        <tr><td colspan="2">
        ...
        <tr><td colspan="2">
            ...
            <LocalReport ReportPath="RDLC\PYR014.rdlc">
            </LocalReport>
            </rsweb:reportviewer>
        </td></tr>
        <tr><td colspan="2">
        <asp:GridView id="GridView1" runat="server" Width="100%" AllowSorting="True" AllowPaging="True"
         ...
         <Columns>             
             ...
             <asp:BoundField DataField="TitleCode" HeaderText="職稱" SortExpression="TitleCode" ItemStyle-Wrap="false" />
             <asp:BoundField DataField="Grade" HeaderText="職等" />
             <asp:BoundField DataField="Sex" HeaderText="性別" />
             <asp:BoundField DataField="IDNo" HeaderText="身分証號" />             
