<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="PYR002PIC.aspx.cs" Inherits="PYR002PIC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <ContentTemplate>
        ...
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="非工資明細" />
...
<!-- 搜尋模組 -->
        <tr align="left"><td colspan="2">計薪年月：<uc8:SalaryYM id="SalaryYM1" runat="server" /> Or <asp:CheckBox ID="ckYMKind" runat="server" />
        <asp:DropDownList ID="RpYMList" runat="server" >                
          <asp:ListItem Value="3" Selected="True">3月(12~2)</asp:ListItem>
          <asp:ListItem Value="6" >6月(3~5)</asp:ListItem>
          <asp:ListItem Value="9" >9月(6~8)</asp:ListItem>
          <asp:ListItem Value="12" >12月(9~11)</asp:ListItem>
        </asp:DropDownList>
        </td></tr>
