<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="PYR010.aspx.cs" Inherits="PYR010" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <ContentTemplate>
        ...
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="薪金簽收表" />
        ...
        <ul>
        <li style="float:left">薪　　別：</li>
        <li><asp:RadioButtonList ID="rbList" runat="server" RepeatDirection="Horizontal">
            <asp:ListItem Value="A" Selected="True">工資</asp:ListItem>
            <asp:ListItem Value="B">非工資</asp:ListItem>
            <asp:ListItem Value="C">獎金</asp:ListItem>
            </asp:RadioButtonList>
        </li>
        <li>獎金發放：<uc5:CodeList id="CodeList1" runat="server" />發放日期：<asp:TextBox ID="BounsDate" runat="server" />
        </li></ul>
        </td></tr>
        <tr><td colspan="2">
            <asp:Button ID="btnQuery" runat="server" Text="查詢" OnClick="btnQuery_Click" Visible="false" />
            <asp:Button ID="btReport" runat="server" Text="報表" OnClick="btReport_Click" /></td></tr>
        <tr><td colspan="2">
        ...
        <tr><td colspan="2">
            ...
            <LocalReport ReportPath="RDLC\PYR010.rdlc">
            </LocalReport>
            </rsweb:reportviewer>
        </td></tr>
        <tr><td colspan="2">
        <asp:GridView id="GridView1" runat="server" Width="100%" AllowSorting="True" AllowPaging="True"
         ...
         <Columns>
             ...
             <asp:BoundField DataField="Pay1000" HeaderText="千元" />
             <asp:BoundField DataField="Pay0500" HeaderText="五百元" />             
             <asp:BoundField DataField="Pay0100" HeaderText="壹百元" />
             <asp:BoundField DataField="Pay0050" HeaderText="伍拾元" />
             <asp:BoundField DataField="Pay0010" HeaderText="拾元" />
             <asp:BoundField DataField="Pay0005" HeaderText="伍元" />
             <asp:BoundField DataField="Pay0001" HeaderText="壹元" />
         </Columns>
     </asp:GridView>
     </td></tr>
     </table>
