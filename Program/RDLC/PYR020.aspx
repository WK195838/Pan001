<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="PYR020.aspx.cs" Inherits="RDLCPYR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <ContentTemplate>
        ...
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="個人加班請假記錄表" />
        ...
        <tr><td colspan="2">
            ...
            <LocalReport ReportPath="RDLC\PYR020.rdlc">
            </LocalReport>
            </rsweb:reportviewer>
        </td></tr>
        <tr><td colspan="2">
        <asp:GridView id="GridView1" runat="server" Width="100%" AllowSorting="True" AllowPaging="True"
         ...
         <Columns>             
             ...
             <asp:BoundField DataField="OTTotal" HeaderText="加班總時數" />
             <asp:BoundField DataField="OverTime1" HeaderText="一般" />
             <asp:BoundField DataField="OverTime2" HeaderText="超時" />
             <asp:BoundField DataField="Holiday" HeaderText="假日" />
             <asp:BoundField DataField="NationalHoliday" HeaderText="國定假日" />
             <asp:BoundField DataField="LTTotal" HeaderText="請假總時數" />
             <asp:BoundField DataField="LT01" HeaderText="曠職" />
             <asp:BoundField DataField="LT02" HeaderText="事假" />
             <asp:BoundField DataField="LT03" HeaderText="傷病" />
             <asp:BoundField DataField="LT04" HeaderText="休假" />
             <asp:BoundField DataField="LT05" HeaderText="公假" />
             <asp:BoundField DataField="LT06" HeaderText="喪假" />
             <asp:BoundField DataField="LT07" HeaderText="婚假" />
             <asp:BoundField DataField="LT08" HeaderText="公傷" />
             <asp:BoundField DataField="LT09" HeaderText="產假" />
             <asp:BoundField DataField="LT10" HeaderText="遲到" />
         </Columns>
     </asp:GridView>
     </td></tr>
     </table>
