<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompanyMaster_U.aspx.cs" Inherits="CompanyMaster_U" %>
...
<uc3:StyleTitle ID="StyleTitle1" runat="server" Title="公司主檔修改" />
...
<tr>
<td>
<asp:DetailsView ID="DetailsView1" runat="server" DefaultMode="Edit" Width="100%" DataSourceID="SqlDataSource1" DataKeyNames="Company" AutoGenerateRows="False" OnItemCreated="DetailsView1_ItemCreated" OnItemUpdated="DetailsView1_ItemUpdated" OnDataBound="DetailsView1_DataBound" OnItemUpdating="DetailsView1_ItemUpdating">
