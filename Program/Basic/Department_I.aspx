<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Department_I.aspx.cs" Inherits="Basic_Department_I" %>
...
<body>
    ...
    <div>
        ...
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="部門資料查詢" />
        <uc4:StyleContentStart ID="StyleContentStart1" runat="server" />
        <table width="100%">
            <tr>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" DataKeyNames="Company,DepCode"
