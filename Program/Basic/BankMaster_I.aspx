<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BankMaster_I.aspx.cs" Inherits="Basic_BankMaster_I" %>
...
<body>
    ...
    <div>
        ...
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="銀行資料查詢" />
        <uc4:StyleContentStart ID="StyleContentStart1" runat="server" />
        <table width="100%">
            <tr>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" DataKeyNames="BankHeadOffice,BankBranch"
