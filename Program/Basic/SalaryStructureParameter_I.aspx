<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryStructureParameter_I.aspx.cs" Inherits="Basic_SalaryStructureParameter_I" %>
...
<body>
    ...
    <div>
        ...
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="薪資結構參數查詢" />
        <uc4:StyleContentStart ID="StyleContentStart1" runat="server" />
        <table width="100%">
            <tr>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" DataKeyNames="SalaryId"
