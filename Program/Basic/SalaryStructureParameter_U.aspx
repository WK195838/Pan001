<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryStructureParameter_U.aspx.cs" Inherits="Basic_SalaryStructureParameter_U" validaterequest="false" EnableEventValidation="false" %>
...
<body>
    ...
    <div>
        ...
        <table width="100%">
            ...
            <tr>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" DefaultMode="Edit" Width="100%" DataSourceID="SqlDataSource1" DataKeyNames="SalaryId" AutoGenerateRows="False" OnItemCreated="DetailsView1_ItemCreated" OnItemUpdated="DetailsView1_ItemUpdated" OnDataBound="DetailsView1_DataBound" OnItemUpdating="DetailsView1_ItemUpdating">
