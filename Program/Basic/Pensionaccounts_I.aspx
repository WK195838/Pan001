<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pensionaccounts_I.aspx.cs" Inherits="Pensionaccounts_I" %>
...
<uc3:StyleTitle ID="StyleTitle1" runat="server" Title="退休金資料維護查詢" />
...
SelectCommand="SELECT Pensionaccounts_Master.* FROM Pensionaccounts_Master WHERE Company = @Company and EmployeeId = @EmployeeId">
