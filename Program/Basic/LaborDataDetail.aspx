...
<uc2:StyleTitle id="StyleTitle1" title="勞工保險資料查詢" runat="server"></uc2:StyleTitle> 
...
<asp:BoundField DataField="TrxType"  HeaderText="異動類別"   SortExpression="TrxType"   >   </asp:BoundField>
<asp:BoundField DataField="EffectiveDate"  HeaderText="生效日期"   SortExpression="EffectiveDate"   >   </asp:BoundField>
<asp:BoundField DataField="LI_amount"  HeaderText="金額"   SortExpression="LI_amount"   >   </asp:BoundField>
</Columns>
<%--------列的內容設定結束--------%>
