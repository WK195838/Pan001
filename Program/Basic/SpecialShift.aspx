<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="SpecialShift.aspx.cs" Inherits="Basic_SpecialShift" EnableEventValidation="false" %>
...
//特別控制
    ...
    <div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>&nbsp; 
<uc2:StyleTitle id="StyleTitle1" title="特別班表" runat="server"></uc2:StyleTitle>
...
<TR><TD colSpan=2>
    ...
    DataKeyNames="Company,ShiftCode" 
...
<%--<asp:BoundField DataField="DeptId" HeaderText="部門代號" SortExpression="DeptId" ></asp:BoundField>ShiftCode
InTime
OutTime
--%>
<asp:BoundField DataField="ShiftCode" HeaderText="班別編號" SortExpression="ShiftCode" ReadOnly="true" ></asp:BoundField>
<asp:BoundField DataField="InTime" HeaderText="應上班時間" SortExpression="InTime"></asp:BoundField>
<asp:BoundField DataField="OutTime" HeaderText="應下班時間" SortExpression="OutTime" ></asp:BoundField>
...
<%--<td>部門代號</td>--%><td>班別編號</td><td>應上班時間</td><td class="paginationRowEdgeRI">應下班時間</td></tr>
...
<td class="Grid_GridLine"><asp:DropDownList runat="server" ID="ddl02" /><asp:label runat="server" ID="lbl01" /><asp:DropDownList runat="server" ID="ddl03" /></td>
<td class="Grid_GridLine"><asp:DropDownList runat="server" ID="ddl04" /><asp:label runat="server" ID="lbl02" /><asp:DropDownList runat="server" ID="ddl05" /></td>
</tr>
</table>
</EmptyDataTemplate>
...
DeleteCommand="DELETE FROM SpecialShift WHERE Company = @Company and ShiftCode=@ShiftCode" 
SelectCommand="SELECT SpecialShift.* FROM SpecialShift " 
InsertCommand="INSERT INTO SpecialShift(Company,ShiftCode,InTime,OutTime) VALUES (@Company,@ShiftCode,@InTime,@OutTime)" 
UpdateCommand="UPDATE SpecialShift SET InTime=@InTime,OutTime=@OutTime WHERE Company = @Company and ShiftCode=@ShiftCode ">
                 <DeleteParameters>
