<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="InsuranceProofReport.aspx.cs" Inherits="RPT_InsuranceProofReport" Title="" EnableEventValidation="false" %>
 ...
 <asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <%--用於執行等畫面(End) --%>
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <ContentTemplate>
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="代扣勞健保保險費及補充保費證明" />
        ...
        <tr align="left"><td>計薪年度：</td><td>民國<asp:DropDownList ID="SalaryY" runat="server" Width="50"/>年</td></tr>
     ...
     <CR:CrystalReportSource ID="cryReportSource" runat="server">
         <Report FileName="InsuranceProofReport01.rpt">
         </Report>
