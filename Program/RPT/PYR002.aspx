<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="PYR002.aspx.cs" Inherits="PYR002" Title="部門薪資彙總表(試算)" %>
 ...
 <asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <%--用於執行等畫面(End) --%>
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <ContentTemplate>
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="部門薪資彙總表(試算)" />
        ...
        <tr align="left"><td>部　　門：</td><td><uc7:CodeList ID="clDeptId_S" runat="server" /> ～ <uc7:CodeList ID="clDeptId_E" runat="server" /></td></tr>
        <tr align="left"><td>員工編號：</td><td><asp:TextBox ID="txtEmpSatrt" runat="server" Width="135px" /> ～ <asp:TextBox ID="txtEmpEnd" runat="server" Width="135px" /></td></tr>
        <tr align="left"><td></td><td>
            <asp:Button ID="btnQuery" runat="server" Text="預覽列印" OnClick="btnQuery_Click" /></td></tr>
        <tr><td colspan="2">
