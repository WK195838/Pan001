<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="PYR003.aspx.cs" Inherits="PYR003" Title="薪資清冊(確認)" %>
 ...
 <asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <%--用於執行等畫面(End) --%>
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <ContentTemplate>
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="薪資清冊(確認)" />
