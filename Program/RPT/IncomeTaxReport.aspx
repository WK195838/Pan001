<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="IncomeTaxReport.aspx.cs" Inherits="Basic_IncomeTaxReport" Title="Untitled Page" %>
 ...
 <asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <%--用於執行等畫面(End) --%>
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <ContentTemplate>
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="所得稅扣繳總表" />
     ...
     <CR:CrystalReportSource ID="cryReportSource" runat="server">
         <Report FileName="IncomeTaxReport.rpt">
         </Report>
