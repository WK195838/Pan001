<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="PYR023.aspx.cs" Inherits="PYR023" Title="成本中心彙總表(試算)" %>
 ...
 <asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <%--用於執行等畫面(End) --%>
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <ContentTemplate>
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="成本中心彙總表(試算)" />
