<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="LeaveTrxStatistics.aspx.cs" Inherits="LeaveTrxStatistics" Title="" %>
 ...
 <asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <%--用於執行等畫面(End) --%>
     <asp:ScriptManager id="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <ContentTemplate>
        <uc3:StyleTitle ID="StyleTitle1" Title="請假統計表" />
        ...
        <tr align="left"><td>請假年月：</td><td><uc8:SalaryYM id="SalaryYM1" runat="server" />(僅限單一月份：<asp:RadioButtonList ID="CKYM" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" ></asp:RadioButtonList>)</td></tr>
     ...
     <CR:CrystalReportSource ID="cryReportSource" runat="server">
         <Report FileName="LeaveTrxStatistics.rpt">
         </Report>
