<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="MyPayrollToPDFList.aspx.cs" Inherits="MyPayrollToPDFList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server"> 
     <div style="text-align:center">
        ...
        <ContentTemplate>
            <uc2:StyleTitle id="StyleTitle1" title="個人獎金單列印" runat="server" /> 
