<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="Payroll013PIC.aspx.cs" Inherits="Payroll013PIC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <ContentTemplate>
        ...
        <asp:GridView id="GridView1" runat="server" Width="100%" AllowSorting="True" AllowPaging="True"
         ...
         <Columns>                                       
                <asp:TemplateField HeaderText="工資">
                    <ItemTemplate>
                    <asp:LinkButton ID="btnSelect1" runat="server" CausesValidation="False"
                ...
                <asp:TemplateField HeaderText="非工資">
                    <ItemTemplate>
                    <asp:LinkButton ID="btnSelect2" runat="server" CausesValidation="False"
                    Text="<img src='../App_Themes/images/select1.gif' border='0' alt='查詢'  style=&quot; filter:alpha(opacity=50);&quot;  onmouseout=&quot;this.filters['alpha'].opacity=50&quot;  onmouseover=&quot;this.filters['alpha'].opacity=100&quot; />" ></asp:LinkButton>
                    </ItemTemplate>
                    <HeaderStyle Width="30px" />
                </asp:TemplateField>                
