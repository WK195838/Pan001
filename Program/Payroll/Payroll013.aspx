<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="Payroll013.aspx.cs" Inherits="Payroll_Payroll013" %>
...
<%@ Register Src="../UserControl/StyleContentEnd.ascx" TagName="StyleContentEnd"
    TagPrefix="uc5" %>
<%@ Register src="../UserControl/CheckAuthorization.ascx" tagname="CheckAuthorization" tagprefix="CheckAuthorization" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server">
    ...
    <ContentTemplate>
    <div style="display:none;"><CheckAuthorization:CheckAuthorization ID="CheckAuthorization1" runat="server" /> </div>
        <uc1:ShowMsgBox ID="ShowMsgBox1" runat="server" />        
        <uc3:StyleTitle ID="StyleTitle1" runat="server" Title="薪資試算作業" />
        ...
        <tr><td colspan="2"><asp:Button ID="btnComputerPayroll" runat="server" Text="薪資試算" OnClick="btnComputerPayroll_Click" />
