<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="PayrollToPDFList.aspx.cs" Inherits="PayrollToPDFList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphEEOC" Runat="Server"> 
     <div style="text-align:center">
        ...
        <ContentTemplate>
            <uc2:StyleTitle id="StyleTitle1" title="個人薪資單列印" runat="server" /> 
         ...
         <li>
         <span>是否在職：</span>
         <asp:RadioButtonList ID="rbResignC" runat="server" RepeatColumns="10" RepeatLayout="Flow" AutoPostBack="true">
         ...
         <li style=" float:none; display:none;">
         ...
         <li>
         計薪年月：起<uc4:SalaryYM id="SalaryYM1" runat="server"></uc4:SalaryYM>迄<uc4:SalaryYM id="SalaryYM2" runat="server"></uc4:SalaryYM>
         </li>         
