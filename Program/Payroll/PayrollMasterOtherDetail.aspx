<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="PayrollMasterOtherDetail.aspx.cs" Inherits="PayrollMasterOtherDetail" EnableEventValidation="false" %>
...
//特別控制
    ...
    <div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>&nbsp; 
<uc2:StyleTitle id="StyleTitle1" title="其它薪資資料" runat="server"></uc2:StyleTitle>
...
<!-- 搜尋模組 -->
 <tr>
    <td align="left"><span class="ItemFontStyle">計薪年月：</span>
        <asp:CheckBox ID="cbYM" runat="server" Text="指定" Checked="true" />
        <uc10:SalaryYM id="SalaryYM1" runat="server" /> ～ 
        <uc10:SalaryYM id="SalaryYM2" runat="server" />
...
SelectCommand="SELECT Company,EmployeeId,SalaryYM,PeriodCode FROM Payroll_Master_OtherDetail" 
DeleteCommand="DELETE FROM Payroll_Master_OtherDetail WHERE (Company = @Company And EmployeeId = @EmployeeId And SalaryYM=@SalaryYM And PeriodCode=@PeriodCode And SalaryItem=@SalaryItem)"
InsertCommand="INSERT INTO Payroll_Master_OtherDetail([Company],[EmployeeId],[SalaryYM],[PeriodCode],[SalaryItem],[SalaryAmount]) VALUES (@Company, @EmployeeId, @SalaryYM, @PeriodCode, @SalaryItem, @SalaryAmount)" 
UpdateCommand="UPDATE Payroll_Master_OtherDetail SET SalaryAmount=@SalaryAmount WHERE (Company = @Company And EmployeeId = @EmployeeId And SalaryYM=@SalaryYM And PeriodCode=@PeriodCode And SalaryItem=@SalaryItem) "
>
                 <DeleteParameters>
