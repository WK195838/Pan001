<%@ Page Language="C#" MasterPageFile="~/EEOC.master" AutoEventWireup="true" CodeFile="PRA_Incomer.aspx.cs" Inherits="PRA_Incomer" EnableEventValidation="false" %>
...
//特別控制
    ...
    <div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>&nbsp; 
<uc2:StyleTitle id="StyleTitle1" title="所得人維護" runat="server"></uc2:StyleTitle>
...
<asp:LinkButton id="btnDelete" onclick="btnDelete_Click" runat="server"
 Text="<img src='../App_Themes/images/delete1.gif' border='0' alt='刪除' style=&quot; filter:alpha(opacity=50);&quot;  onmouseout=&quot;this.filters['alpha'].opacity=50&quot;  onmouseover=&quot;this.filters['alpha'].opacity=100&quot; />"
  OnClientClick='return confirm("確定刪除?");' L1PK='<%# DataBinder.Eval(Container, "DataItem.Company")%>' L2PK='<%# DataBinder.Eval(Container, "DataItem.IDNo")%>'
