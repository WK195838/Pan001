<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayrollToPDF.aspx.cs" Inherits="PayrollToPDF" %>

<%@ Register Src="../UserControl/PeriodList.ascx" TagName="PeriodList" TagPrefix="uc8" %>
...
<body>
    ...
    <%--用於執行等畫面(End) --%>
            <uc2:StyleTitle id="StyleTitle1" title="個人薪資單下載" runat="server" /> 
         ...
         <li style=" float:none">
         PDF密碼變更：<asp:TextBox id="NewPassword" runat="server" Width="157px" TextMode="Password" MaxLength="14" onKeyPress="checkCapsLock( event, this)"></asp:TextBox>
         </li>
         
         <li>
         PDF密碼再確認：<asp:TextBox id="NewPassWord2" runat="server" Width="157px" TextMode="Password" MaxLength="14" onKeyPress="checkCapsLock( event, this)"></asp:TextBox>
         </li>
         
         <li>
         計薪年月：<uc4:SalaryYM id="SalaryYM1" runat="server"></uc4:SalaryYM>
         </li>
         <li>
         <span>期　　別：</span>
         <uc8:PeriodList id="PeriodList1" runat="server"></uc8:PeriodList> 日
         </li>
