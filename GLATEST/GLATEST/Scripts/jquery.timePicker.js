        ...
        $(elm)[event](function (e) {
            ...
            switch (e.keyCode) {
                ...
                case 27: // Esc
                    ...
                    break;
                default: // Other                    
                    if (e.keyCode == 8 || e.keyCode == 9 || e.keyCode == 16 || e.keyCode == 46 || e.keyCode == 110 || e.keyCode == 186) {
                        return true;
                    }
                    else if (e.keyCode >= 48 && e.keyCode <= 57 || e.keyCode >= 96 && e.keyCode <= 105) {
                        $selected = $(selectedSelector, $tpList);
                        var reg = /^[0-9]*$/;
                        if (!reg.test(String.fromCharCode(e.keyCode)))
                            return false;
                        var i = 0, iMax = 20;
                        elm.value = elm.value + '' + String.fromCharCode(e.keyCode);
                        switch (elm.value.length) {
                            case 1:
                                if (elm.value == '0') {
                                    elm.value = elm.value + '9:00';
                                }
                                else
                                { elm.value = elm.value + '0:00'; }
                                break;
                            case 2:
                            ...
                            case 4:
                                ...
                                break;
                            default:
                                elm.value = elm.value.substr(0, 5);
                                break;
                        }

                        var next = $selected;
                        if (elm.value > next.text()) {

                            while (elm.value > next.text() && i < iMax) {
                                i = i + 1;
                                next.removeClass(selectedClass);
                                next = next.next();
                                next.addClass(selectedClass)[0];
