...
$(document).ready(function () {
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        //select: selectDate,
        editable: true,
        events: "../UserControl/WFA/wfaCalendarJsonResponse.ashx?WFAItem=" + WFAItem + "&Param=" + Param,
        ...
        eventRender: function (event, element, monthView) {
            ...
            //部顯示本月以外的event -- 2012/11/23 by Desmond
    ...
    //如果為Working Calendar頁面，預設agendaWeek View
    if (WFAItem == "W") {
