<%@ Page Language="C#" MasterPageFile="~/GLA.master" AutoEventWireup="true" CodeFile="GLA0450.aspx.cs" Inherits="GLA0450" %>
...
<uc2:StyleTitle id="StyleTitle1" title="分類帳碼資料維護" runat="server"></uc2:StyleTitle> 
...
<tr class="QueryStyle">
 ...
 <tr><td align="left" colspan="2"><asp:Panel id="Panel_Empty" runat="server" Width="250px" Visible="False" Height="50px">
                                ...
                                DataKeyNames="Company,SubLedCode" 
                                AutoGenerateColumns="False" ShowFooter="True" DataSourceID="sqlDatasource">
                                 
                                 <Columns>
                                        <asp:TemplateField HeaderText="刪除" ShowHeader="False">
                                            <ItemTemplate>
                                            <asp:LinkButton ID="btnDelete" runat="server" CausesValidation="False"  OnClick="btnDelete_Click" L1PK='<%# DataBinder.Eval(Container, "DataItem.Company")%>'  L2PK='<%# DataBinder.Eval(Container, "DataItem.SubLedCode")%>'
                                     ...
                                     <asp:BoundField DataField="SubLedCode" HeaderText="分類帳碼" 
                                            SortExpression="SubLedCode" >
                                         <ItemStyle HorizontalAlign="Center" />
                                     </asp:BoundField>
                                     <asp:BoundField DataField="Description" HeaderText="說明" ItemStyle-Width="30%" />
                                     <asp:BoundField DataField="SubLedCtl" HeaderText="控制碼" SortExpression="SubLedCtl" >
                                         <ItemStyle HorizontalAlign="Center" />
                                     </asp:BoundField>
                                 </Columns>
