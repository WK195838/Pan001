<%@ Page Language="C#" MasterPageFile="~/GLA.master" AutoEventWireup="true" CodeFile="PTA0170.aspx.cs" Inherits="PTA0170" %>
...
<uc2:StyleTitle id="StyleTitle1" title="員工基本資料維護" runat="server"></uc2:StyleTitle> 
                                ...
                                AutoGenerateColumns="False" ShowFooter="True" DataSourceID="sqlDatasource">
                                 ...
                                 <Columns>
                                     ...
                                     <asp:BoundField DataField="Blood" HeaderText="血型" SortExpression="Blood" >
                                        ...
                                        <asp:BoundField DataField="IDNo" HeaderText="身分證號" 
                                            SortExpression="IDNo" />
                                        <asp:BoundField DataField="Sex" HeaderText="性別" SortExpression="Sex" />
                                        <asp:BoundField DataField="Birthday" HeaderText="出生日期" 
                                            SortExpression="Birthday" />
                                        <asp:BoundField DataField="CommAddress" HeaderText="通訊地址" 
                                            SortExpression="CommAddress" />
                                        <asp:BoundField DataField="CommTEL" HeaderText="通訊電話" 
                                            SortExpression="CommTEL" />
                                        <asp:BoundField DataField="OnBoardDate" HeaderText="到職日期" 
                                            SortExpression="OnBoardDate" />
