<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GLR0320.aspx.cs" MasterPageFile="~/GLA.master" Inherits="GLR0320" %>
				...
				<div>
					...
					<table cellpadding="1" cellspacing="0"  width="99.5%" class='dialog_body'>
						<tr >
							...
							<td> 
                                <asp:DropDownList ID="DrpAcctFromPeriod" runat="server">
                                ...
                                </asp:DropDownList>－<asp:DropDownList ID="DrpAcctToPeriod" runat="server">
                                    <asp:ListItem>01</asp:ListItem>
                                    <asp:ListItem Value="02"></asp:ListItem>
                                    <asp:ListItem Value="03"></asp:ListItem>
                                    <asp:ListItem Value="04"></asp:ListItem>
						...
						<tr >
							...
							<td colspan="5">
								<asp:Label ID="Label2" runat="server" Font-Names="新細明體" Font-Size="12pt" ForeColor="Black"
									Text="成本中心１："></asp:Label>
                                <asp:DropDownList ID="DrpDepart1" runat="server">
                                </asp:DropDownList></td>
						</tr>
						<tr >
							<td colspan="7" style="height: 26px">
								<asp:Label ID="Label7" runat="server" Font-Names="新細明體" Font-Size="12pt" ForeColor="Black"
									Text="成本中心２～４："></asp:Label>
                                <asp:DropDownList ID="DrpDepart2" runat="server">
                                </asp:DropDownList>&nbsp;
                                <asp:DropDownList ID="DrpDepart3" runat="server">
                                </asp:DropDownList>&nbsp;
                                <asp:DropDownList ID="DrpDepart4" runat="server">
                                </asp:DropDownList></td>
						</tr>
						<tr >
							<td colspan="7">
								<asp:Label ID="Label8" runat="server" Font-Names="新細明體" Font-Size="12pt" ForeColor="Black"
									Text="成本中心５～７："></asp:Label>
                                <asp:DropDownList ID="DrpDepart5" runat="server">
                                </asp:DropDownList>&nbsp;
                                <asp:DropDownList ID="DrpDepart6" runat="server">
                                </asp:DropDownList>&nbsp;
                                <asp:DropDownList ID="DrpDepart7" runat="server">
                                </asp:DropDownList></td>
						</tr>
						<tr >
