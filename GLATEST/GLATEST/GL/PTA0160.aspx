<%@ Page Language="C#" MasterPageFile="~/GLA.master" AutoEventWireup="true" CodeFile="PTA0160.aspx.cs" Inherits="PTA0160" %>
...
<uc2:StyleTitle id="StyleTitle1" title="廠商基本資料維護" runat="server"></uc2:StyleTitle> 
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        廠商名稱：</td>
                    <td>
                        <asp:TextBox ID="txtVendFName" runat="server"></asp:TextBox>
                    </td>
                </tr>
            </table>
...
<tr class="QueryStyle">
 ...
 <tr><td align="left" colspan="2"><asp:Panel id="Panel_Empty" runat="server" Width="250px" Visible="False" Height="50px">
                                ...
                                DataKeyNames="Company,VendorID" 
                                AutoGenerateColumns="False" ShowFooter="True" DataSourceID="sqlDatasource">
                                 
                                 <Columns>
                                        <asp:TemplateField HeaderText="刪除" ShowHeader="False">
                                            <ItemTemplate>
                                            <asp:LinkButton ID="btnDelete" runat="server" CausesValidation="False"  OnClick="btnDelete_Click" L1PK='<%# DataBinder.Eval(Container, "DataItem.Company")%>'  L2PK='<%# DataBinder.Eval(Container, "DataItem.VendorID")%>'
                                     ...
                                     <asp:BoundField DataField="VendorID" HeaderText="廠商代號" 
                                            SortExpression="VendorID" >
                                         <ItemStyle HorizontalAlign="Center" />
                                     </asp:BoundField>
                                     <asp:BoundField DataField="VendSName" HeaderText="廠商簡稱" 
                                            SortExpression="VendSName"  />
                                     <asp:BoundField DataField="Addess1" HeaderText="廠商地址1" SortExpression="Addess1" >
                                         <ItemStyle HorizontalAlign="Center" />
                                     </asp:BoundField>
                                        <asp:BoundField DataField="ContPsn01" HeaderText="聯絡人一" 
                                            SortExpression="ContPsn01" />
                                        <asp:BoundField DataField="Tel01" HeaderText="電話一" SortExpression="Tel01" />
                                        <asp:BoundField DataField="FaxN0" HeaderText="傳真號碼" SortExpression="FaxN0" />
