<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/GLA.master" CodeFile="GLR01H0.aspx.cs" Inherits="GLR01H0" %>
                    ...
                    <table cellpadding="1" cellspacing="0" width="99.5%" class='dialog_body'>
                        ...
                        <tr class="QueryTerm">
                            ...
                            <td >
                                ...
                                <%--<asp:ImageButton ID="ibOW_SDate" runat="server" SkinID="Calendar1" />--%>～<asp:TextBox
