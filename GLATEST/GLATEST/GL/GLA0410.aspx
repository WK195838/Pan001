<%@ Page Language="C#" MasterPageFile="~/GLA.master" AutoEventWireup="true" CodeFile="GLA0410.aspx.cs" Inherits="GLA0410" %>
...
<uc2:StyleTitle id="StyleTitle1" title="會計科目資料維護" runat="server"></uc2:StyleTitle> 
...
<tr class="QueryStyle">
 ...
 <tr><td align="left" colspan="2"><asp:Panel id="Panel_Empty" runat="server" Width="250px" Visible="False" Height="50px">
                                ...
                                DataKeyNames="Company,AcctNo" 
                                AutoGenerateColumns="False" ShowFooter="True" DataSourceID="sqlDatasource">
                                 
                                 <Columns>
                                        <asp:TemplateField HeaderText="刪除" ShowHeader="False">
                                            <ItemTemplate>
                                            <asp:LinkButton ID="btnDelete" runat="server" CausesValidation="False"  OnClick="btnDelete_Click" L1PK='<%# DataBinder.Eval(Container, "DataItem.Company")%>'  L2PK='<%# DataBinder.Eval(Container, "DataItem.AcctNo")%>'
                                     ...
                                     <asp:BoundField DataField="AcctNo" HeaderText="會計科目" SortExpression="AcctNo" />
                                     <asp:BoundField DataField="AcctDesc1" HeaderText="科目中文名稱" SortExpression="AcctDesc1" />
                                     <asp:BoundField DataField="AcctDesc2" HeaderText="科目英文名稱" SortExpression="AcctDesc2" />
                                     <asp:BoundField DataField="AcctType" HeaderText="科目類別" SortExpression="AcctType" />
                                     <asp:BoundField DataField="AcctCtg" HeaderText="科目屬性" SortExpression="AcctCtg" />
                                     <asp:BoundField DataField="AcctClass" HeaderText="科目等級" SortExpression="AcctClass" />
                                     <asp:BoundField DataField="ASpecialAcct" HeaderText="特定科目" SortExpression="ASpecialAcct" />
                                 </Columns>
