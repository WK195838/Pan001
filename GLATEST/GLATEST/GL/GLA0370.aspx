<%@ Page Language="C#" MasterPageFile="~/GLA.master" AutoEventWireup="true" CodeFile="GLA0370.aspx.cs" Inherits="GLA0370" %>
...
<uc2:StyleTitle id="StyleTitle1" title="公司結構設定" runat="server" 
...
<tr class="QueryStyle">
 ...
 <tr><td align="center" colspan="2"><asp:Panel id="Panel_Empty" runat="server" Width="250px" Visible="False" Height="50px">
                                ...
                                AutoGenerateColumns="False" ShowFooter="True" DataSourceID="sqlDatasource" 
                                 ...
                                 <Columns>
                                     ...
                                     <asp:BoundField DataField="Company" HeaderText="公司別" ReadOnly="True" 
                                          SortExpression="Company" HeaderStyle-Width="25%" >
