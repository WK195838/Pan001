<%@ Page Language="C#" MasterPageFile="~/GLA.master" AutoEventWireup="true" CodeFile="GLA0380.aspx.cs" Inherits="GLA0380" %>
...
<uc2:StyleTitle id="StyleTitle1" title="成本中心結構設定" runat="server" 
...
<tr class="QueryStyle">
 ...
 <tr><td align="left" colspan="2"><asp:Panel id="Panel_Empty" runat="server" Width="250px" Visible="False" Height="50px">
                                ...
                                DataKeyNames="Company,HDepartment" 
                                AutoGenerateColumns="False" ShowFooter="True" DataSourceID="sqlDatasource">
                                 ...
                                 <Columns>
                                      ...
                                      <asp:TemplateField HeaderText="刪除" ShowHeader="False">
                                            <ItemTemplate>
                                            <asp:LinkButton ID="btnDelete" runat="server" CausesValidation="False"  OnClick="btnDelete_Click" L1PK='<%# DataBinder.Eval(Container, "DataItem.Company")%>'  L2PK='<%# DataBinder.Eval(Container, "DataItem.HDepartment")%>'
                                     ...
                                     <asp:BoundField DataField="Company" HeaderText="公司別" ReadOnly="True" SortExpression="Company" HeaderStyle-Width="30%" />
                                     <asp:BoundField DataField="HDepartment" HeaderText="部門" 
                                          SortExpression="HDepartment"  HeaderStyle-Width="10%"/>
