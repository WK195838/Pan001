...
public partial class GLA0110N    : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        ScriptManager1.RegisterPostBackControl(imgbtnNewJourail);      
        _MyDBM= new DBManger();
        _MyDBM.New();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            imgAcctNo.Attributes.Add("onclick", "return GetAcctnoPopupDialog(550, 400, '" + DrpCompanyList.SelectValue.Trim() + "', 'GLAcctDef', 'CodeCode,CodeName', '" + txtAcctNo.ClientID + "','" + lblAcctNo.ClientID + "','" + txtReValue.ClientID + "');");
        ...
        {
            imgbtnOKJournailzing.Attributes.Add("style", "display:inline");
            imgbtnReset.Attributes.Add("style", "display:inline");
        }
            ...
            {//不為空時時,至少能切成4組字串
                ...
                {                
                    ...
                    theimgICO.Attributes.Add("onclick", "return GetPopupDialog(530, 400, '"
                        + DrpCompanyList.SelectValue.Trim() + "', '" + spl[0] + "', 'CodeCode,CodeName', '"
                        + theValueText.ClientID + "','" + thelblDesc.ClientID + "','" + thetxtReValue.ClientID + "','"
                        + thetxtReValue.Text.ToString().Trim() + "');");
                    #endregion
                }
                thelblDesc.Text = GetJournailzingName(DrpCompanyList.SelectValue.Trim(),
                                                spl[0],
    ...
    protected void GetJournailData(string tCompany, string tVoucherNo)
    {
        ...
        try
        {
            ...
            {
                //傳票表頭
                DrpCompanyList.SelectValue = dt.Rows[0]["Company"].ToString();
    ...
    protected void imgbtnPrintAndSaveJournail_Click(object sender, ImageClickEventArgs e)
    {
       ...
       {
          throw new Exception("複製新增傳票發生問題! \r\n<BR>" + ex);
       }
    }
    ...
    protected void imgbtnNewJourail_Click(object sender, ImageClickEventArgs e)
    {
       ...
       // txtSingleJournailzing.Text = "";
        ...
        //Server.Transfer("~/GL/GLA0110N.aspx", false);
    }
    //傳票存檔
    protected void SaveJourmail()
    {
        ...
        //公司別不可以空白
        if (DrpCompanyList.SelectValue.Trim() == "")
        {
        ...
        //傳票日期的結帳期數是否結帳
        if (GetPeriodClose(DrpCompanyList.SelectValue.Trim(), strJournailDate.Replace("/", "")) == "Y")
        {
        ...
        //傳票已經 Approval 不可以編輯
        if (GetApprovalCode(DrpCompanyList.SelectValue.Trim(), Session["OPMode"].ToString(), Session["VoucherNo"].ToString()) == "Y")
        {
        ...
        if (Session["OPMode"].ToString().ToUpper() == "NEW")
        {
            txtJournailNo.Text = GetVoucherNo(DrpCompanyList.SelectValue.Trim(),
        ...
        string sString = "";
        sString += "document.getElementById(\""+txtJournailNo.ClientID+"\").innerText = " + txtJournailNo.Text + ";";
        ...
        tReturn = UpdateVoucherData(DrpCompanyList.SelectValue.Trim(),
    ...
    protected bool UpdateVoucherData(string tCompany, string tOPMode, string tVoucherNo)
    {
        ...
        if (Items.Length > 0)
        {
            ...
            {
                if (Items[i].ToString() != "")
                    tReturn = InsertGLVoucherDetail(tCompany, tVoucherNo, Convert.ToDecimal(i + 1), Items[i].ToString());
    ...
    protected bool InsertGLVoucherHead(string tCompany, string tVoucherNo)
    {
        ...
        sqlCmd.Parameters.Add("@VoucherEntryDate", SqlDbType.Char, 8).Value = DateTime.Now.ToString("yyyyMMdd");//txtJournailDate.Text.Trim().Replace("/", "");
    ...
    protected bool InsertGLVoucherDetail(string tCompany, string tVoucherNo, decimal tVoucherSeqNo, string tJournalString)
    {
        ...
        sqlCmd.Parameters.Add("@Index07", SqlDbType.NVarChar, 50).Value = Jrn6[4].Trim();
        ...
        sqlCmd.Parameters.Add("@JournalDesc", SqlDbType.NVarChar, 500).Value = sItems[4].Trim();
        sqlCmd.Parameters.Add("@VoucherSource", SqlDbType.Char, 2).Value = "GL";
        sqlCmd.Parameters.Add("@PostCode", SqlDbType.Char, 1).Value = "N";
        sqlCmd.Parameters.Add("@ApprovalCode", SqlDbType.Char, 1).Value = "N"; //預設應為N
        sqlCmd.Parameters.Add("@DletFlag", SqlDbType.Char, 1).Value = "";
