...
public partial class UserControls_Customer : System.Web.UI.UserControl, IproCustomer
{
    #region Iprovider 成員
    //為了將usercontrol值帶回底層頁面
    public event CustomerEventHandler CustomerChanged;
    ...
    {
        if (Request.Form[Stool.EventArgument] == "doCustomerPostBack")
        {
    ...
    private void RegisterJS()
    {
        ...
        function doGetData_" + guid + @"() {
            ...
            var query = $('#" + hfQuery.ClientID + @"').val();      
                var parmwhere = ""1=1"";
                parmwhere += "" AND ("";
                parmwhere += "" CodeName LIKE '%"" + query + ""%' and  CodeID = 'C01'"";
                parmwhere += "")"";                  
                ...
                success: function (msg) {
                    ...
                    if (datas != '' && datas.length > 0) {
                        ...
                        $.each(dataArray, function (i, item) {
                            ...
                            var argument = '""doCustomerPostBack""';
