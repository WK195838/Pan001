...
public partial class UserControls_Employee : System.Web.UI.UserControl, IproEmployee
{
    #region Iprovider 成員
    //為了將usercontrol值帶回底層頁面
    public event EmployeeEventHandler EmployeeChanged;
    ...
    {
        if (Request.Form[Stool.EventArgument] == "doEmployeePostBack")
        {
    ...
    private void RegisterJS()
    {
        ...
        function doGetData_" + guid + @"() {
            ...
            var query = $('#" + hfQuery.ClientID + @"').val();      
                var parmwhere = ""1=1"";
                parmwhere += "" AND ("";
                parmwhere += "" CodeName LIKE '%"" + query + ""%' and  CodeID = 'EMPLOYEE'"";
                parmwhere += "")"";                  
                ...
                success: function (msg) {
                    ...
                    if (datas != '' && datas.length > 0) {
                        ...
                        $.each(dataArray, function (i, item) {
                            ...
                            var argument = '""doEmployeePostBack""';
