...
public partial class UserControls_BankAccount20 : System.Web.UI.UserControl, IproBankAccount20
{
    #region Iprovider 成員
    //為了將usercontrol值帶回底層頁面
    public event BankAccount20EventHandler BankAccount20Changed;
    private BankAccount20Data data;
    #endregion
    ...
    {
        if (Request.Form[Stool.EventArgument] == "doBankAccount20PostBack")
        {
    ...
    {
        if (BankAccount20Changed != null)
        {
            char Delimiter = '＠';
            string jsonString = string.Empty;
            string[] str = arg.Split(Delimiter);
            data = new BankAccount20Data();
            if (str.Length > 0)
            {
            ...
            //將值透過interface傳到頁面
            BankAccount20Changed(this, data);
        }
    ...
    private void RegisterJS()
    {
        ...
        function doGetData_" + guid + @"() {
            ...
            var query = $('#" + hfQuery.ClientID + @"').val();      
                var parmwhere = ""1=1"";
                parmwhere += "" AND ("";
                parmwhere += "" CodeName LIKE '%"" + query + ""%' and  CodeID = 'AH09'"";
                parmwhere += "")"";                  
                ...
                success: function (msg) {
                    ...
                    if (datas != '' && datas.length > 0) {
                        ...
                        $.each(dataArray, function (i, item) {
                            ...
                            var argument = '""doBankAccount20PostBack""';
