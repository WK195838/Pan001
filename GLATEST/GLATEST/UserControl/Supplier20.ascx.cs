...
public partial class UserControls_Supplier20 : System.Web.UI.UserControl, IproSupplier20
{
    #region Iprovider 成員
    //為了將usercontrol值帶回底層頁面
    public event Supplier20EventHandler Supplier20Changed;
    private Supplier20Data data;
    #endregion
    ...
    {
        if (Request.Form[Stool.EventArgument] == "doSupplier20PostBack")
        {
    ...
    {
        if (Supplier20Changed != null)
        {
            char Delimiter = '＠';
            string jsonString = string.Empty;
            string[] str = arg.Split(Delimiter);
            data = new Supplier20Data();
            if (str.Length > 0)
            {
    ...
    private void RegisterJS()
    {
        ...
        function doGetData_" + guid + @"() {
            ...
            var query = $('#" + hfQuery.ClientID + @"').val();      
                var parmwhere = ""1=1"";
                parmwhere += "" AND ("";
                parmwhere += "" CodeName LIKE '%"" + query + ""%' and  CodeID = 'V01'"";
                parmwhere += "")"";                  
                ...
                success: function (msg) {
                    ...
                    if (datas != '' && datas.length > 0) {
                        ...
                        $.each(dataArray, function (i, item) {
                            ...
                            var argument = '""doSupplier20PostBack""';
