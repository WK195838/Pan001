...
public partial class UserControls_SoftWare2 : System.Web.UI.UserControl, IproSoftWare2
{
    #region Iprovider 成員
    //為了將usercontrol值帶回底層頁面
    public event SoftWare2EventHandler SoftWare2Changed;
    private SoftWare2Data data;
    #endregion
    ...
    {
        if (Request.Form[Stool.EventArgument] == "doSoftWare2PostBack")
        {
    ...
    {
        if (SoftWare2Changed != null)
        {
            char Delimiter = '＠';
            string jsonString = string.Empty;
            string[] str = arg.Split(Delimiter);
            data = new SoftWare2Data();
            if (str.Length > 0)
            {
    ...
    private void RegisterJS()
    {
        ...
        function doGetData_" + guid + @"() {
            ...
            var query = $('#" + hfQuery.ClientID + @"').val();      
                var parmwhere = ""1=1"";
                parmwhere += "" AND ("";
                parmwhere += "" CodeName LIKE '%"" + query + ""%' and  CodeID = 'SFT1'"";
                parmwhere += "")"";                  
                ...
                success: function (msg) {
                    ...
                    if (datas != '' && datas.length > 0) {
                        ...
                        $.each(dataArray, function (i, item) {
                            ...
                            var argument = '""doSoftWare2PostBack""';
