...
public partial class UserControls_Hardware : System.Web.UI.UserControl, IproHardware
{
    #region Iprovider 成員
    //為了將usercontrol值帶回底層頁面
    public event HardwareEventHandler HardwareChanged;
    ...
    {
        if (Request.Form[Stool.EventArgument] == "doHardwarePostBack")
        {
    ...
    private void RegisterJS()
    {
        ...
        function doGetData_" + guid + @"() {
            ...
            var query = $('#" + hfQuery.ClientID + @"').val();      
                var parmwhere = ""1=1"";
                parmwhere += "" AND ("";
                parmwhere += "" CodeName LIKE '%"" + query + ""%' and  CodeID = 'H-TYPE'"";
                parmwhere += "")"";                  
                ...
                success: function (msg) {
                    ...
                    if (datas != '' && datas.length > 0) {
                        ...
                        $.each(dataArray, function (i, item) {
                            ...
                            var argument = '""doHardwarePostBack""';
